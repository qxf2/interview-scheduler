...
Revision ID: b6ae6ceda09c
Revises: 
Create Date: 2019-09-10 20:05:01.868544
...
def upgrade():
    ...
    op.create_table('roleinterviewercombine',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('roleinterviewercombine')
